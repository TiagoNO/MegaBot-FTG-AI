...
public class MegaBot implements AIInterface {
	...
	public void xmlUtilidadeClose() throws SAXException
	{
		...
		PATH = PATH + File.separator + "data" + File.separator + "aiData" + File.separator + "MegaBot" + File.separator + "Utilidade.xml";
		...
		if(arquivo.exists())
		{
			try
			{
				...
				linha = "	<BANZAI Q=" + "\"" + Q[0] + "\"" + " />\n";
				writer.write(linha);
				linha = "	<Thunder01 Q=" + "\"" + Q[1] + "\"" + " />\n";
				writer.write(linha);
				linha = "	<DragonSurvivor Q=" + "\"" + Q[2] + "\"" + " />\n";
				writer.write(linha);
				linha = "</MegaBot>";
				writer.write(linha);
	...
	public void XmlUtilidadeInicio() throws SAXException
	{
		...
		if(arquivo.exists())
		{
			try
			{
				...
				xmlStringBuilder.append("<?xml version=\"1.0\"?> <MegaBot> </MegaBot>");
				ByteArrayInputStream input = new ByteArrayInputStream(xmlStringBuilder.toString().getBytes("UFT-8"));
				...
				{
					 child1 = child.item(i);
					 Q[i] = Float.valueOf(child1.getNodeValue());
					 if(Q[i] > Q[Posi] )
					 {
						 Posi = i;
					 }
