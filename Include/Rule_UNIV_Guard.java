...
public class Rule_UNIV_Guard implements RuleLine {
	...
	public String getStr(){
		return "Uni_Guard("+priority+","+weight+","+activated+")";		
	}
	...
	public Key exeAction(CommandCenter cc) {
		...
		if(cc.getDistanceY() == 0){
			cc.commandCall("1 1 1 1 1 1 1 1");
		} else {
			cc.commandCall("4 4 4 4 4 4 4 4");
		}
